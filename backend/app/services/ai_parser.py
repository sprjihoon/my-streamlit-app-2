...
8. "chat_mode_start" - 대화모드 시작 (대화모드, 대화모드 시작, 챗모드, 대화하자 등)
9. "chat_mode_end" - 대화모드 종료 (대화모드 종료, 대화모드 끝, 대화 끝 등)
10. "work_mode_start" - 작업모드 시작 (작업모드, 작업모드 시작, 일하자 등)
11. "work_mode_end" - 작업모드 종료 (작업모드 종료, 작업 끝 등)
...
- 외부 정보 검색 (회사 조사, 서비스 검색, 뉴스, 일반 지식) → web_search
  - "~에 대해 조사해줘", "~가 뭐야?", "정보 알아봐줘", "인터넷에서 찾아봐"
- 작업일지 DB 검색 (틸리언 작업, 어제 내역 등 내부 기록 조회) → search_query
- 중요: "조사해줘"가 있어도 작업일지 내역 조회면 work_log_query나 search_query
- 중요: 외부 회사/서비스/정보를 물어보면 반드시 web_search
- 애매하면 chat

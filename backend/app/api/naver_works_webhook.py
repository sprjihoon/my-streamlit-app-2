...
async def process_message(
    ...
    if intent == "help":
        ...
        help_main = (
            ...
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            "💡 자연어로 편하게 말씀하세요!\n"
            "아래는 예시일 뿐, 비슷한 말로도 인식됩니다.\n\n"
            "📝 【작업 입력】\n"
            "• 틸리언 1톤하차 3만원\n"
            "• 나블리 양품화 20개 800원\n"
            "• A업체 검수 50000원 (숫자도 OK)\n\n"
            "📊 【조회/검색】\n"
            "• 오늘 작업 정리해줘 / 오늘꺼 보여줘\n"
            "• 이번주 작업 / 지난달 일지\n"
            "• 틸리언 작업 검색 / 3만원짜리 뭐있어?\n\n"
    ...
    if "도움말" in text and ("조회" in text or "검색" in text or "보기" in text):
        help_query = (
            ...
            "• 이번달 / 이번 달 / 2월 작업\n"
            "• 지난달 / 저번달 / 1월 일지\n"
            "• 1월 20일부터 25일까지 / 20일~25일\n\n"
            "🔍 【조건 검색 (조합 가능)】\n"
            "• 틸리언 작업 / 틸리언꺼 / 틸리언 뭐있어?\n"
            "• 3만원짜리 / 30000원 작업 / 3만원꺼\n"
            "• 하차 작업 / 양품화 검색 / 바코드 몇 개?\n"
            "• 오늘 틸리언 / 어제 나블리 3만원\n\n"
            "📥 【다운로드】\n"
            "• 조회 결과에 엑셀 다운로드 링크 포함\n\n"
            "💡 자연어로 편하게 물어보세요!\n"
            "\"이번주 틸리언 뭐 했어?\" 처럼요"
        )
    ...
    # 상세 도움말 - 고급
    if "도움말" in text and ("고급" in text or "기타" in text or "추가" in text or "전체" in text):
        help_advanced = (
            "🔧 고급 기능\n"
            "━━━━━━━━━━━━━━━━━━━━\n\n"
            "📝 【메모 추가】\n"
        ...
        await nw_client.send_text_message(channel_id, help_advanced, channel_type)
        return
    ...
    if existing_state and existing_state.get("missing"):
        ...
        non_continue_intents = [
            "greeting", "help", "test", "web_search", "dashboard", "chat"
        ]
